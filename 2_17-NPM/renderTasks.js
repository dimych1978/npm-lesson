// import из собственной библиотеки
// import {
//   formatDateToRu,
//   formatDateToUs,
// } from "./lib/formatData/formatData.js";
  ...
  const tasksHtml = tasks
    .map((task) => {
      ...
      <li class="task">
         ...
         <p> <i>Задача создана: ${
           (console.log(new Date(task.created_at)),
           format(new Date(task.created_at), "dd/MM/yyyy hh:mm:ss.SSS"))
         } </i> </p>
      </li>`;
    })
    .join("");
